  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col font-sans text-slate-900 dark:text-slate-100 transition-colors duration-300">
        ...
        {analysisState.status === 'idle' && (
          <div className="w-full max-w-4xl px-4 py-12 flex flex-col items-center animate-fade-in-up">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 w-full text-center">
               <div className="p-4 bg-white dark:bg-slate-900/50 rounded-2xl shadow-sm dark:shadow-none border border-transparent dark:border-slate-800 transition-colors">
                 <div className="bg-teal-100 dark:bg-teal-900/30 w-12 h-12 rounded-lg flex items-center justify-center mx-auto mb-3 text-teal-700 dark:text-teal-400 font-bold text-xl">1</div>
               ...
               <div className="p-4 bg-white dark:bg-slate-900/50 rounded-2xl shadow-sm dark:shadow-none border border-transparent dark:border-slate-800 transition-colors">
                 <div className="bg-teal-100 dark:bg-teal-900/30 w-12 h-12 rounded-lg flex items-center justify-center mx-auto mb-3 text-teal-700 dark:text-teal-400 font-bold text-xl">2</div>
               ...
               <div className="p-4 bg-white dark:bg-slate-900/50 rounded-2xl shadow-sm dark:shadow-none border border-transparent dark:border-slate-800 transition-colors">
                 <div className="bg-teal-100 dark:bg-teal-900/30 w-12 h-12 rounded-lg flex items-center justify-center mx-auto mb-3 text-teal-700 dark:text-teal-400 font-bold text-xl">3</div>
        ...
        {analysisState.status === 'error' && (
          <div className="w-full max-w-lg mx-auto mt-12 px-4 animate-shake">
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-6 flex flex-col items-center text-center">
              ...
              <button 
                onClick={handleReset}
                className="px-6 py-2 bg-white dark:bg-slate-800 border border-red-300 dark:border-red-700 text-red-700 dark:text-red-300 font-semibold rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
              >
                Tekrar Dene
              </button>
            </div>
      ...
      <footer className="bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 py-6 mt-auto transition-colors duration-300">
        <div className="container mx-auto px-4 text-center text-slate-400 dark:text-slate-600 text-sm">
